...
import 'package:admin_foodnowaste/loginscreen.dart';
import 'package:admin_foodnowaste/payment.dart';
import 'package:admin_foodnowaste/registrationscreen.dart';
import 'package:admin_foodnowaste/splashscreen.dart';
...
String urlgetuser = "http://mobilehost2019.com/adminTestFinal/PHP/get_user.php";
String urluploadImage ="http://mobilehost2019.com/adminTestFinal/PHP/upload_imageprofile.php";
String urlupdate = "http://mobilehost2019.com/adminTestFinal/PHP/update_profile.php";
File _image;
int number = 0;
String _value;
                      ...
                      children: <Widget>[
                        Stack(children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              Center(
                                child: Text("Admin Food No Waste",
                                    style: TextStyle(
                                        fontSize: 24,
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "http://mobilehost2019.com/adminTestFinal/PHP/PROFILE/${widget.user.email}.jpg?dummy=${(number)}")))),
                              ),
                              SizedBox(height: 5),
                              Container(
                                child: Text(
