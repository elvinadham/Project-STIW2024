...
class _DetailInterfaceState extends State<DetailInterface> {
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          height: 200,
          child: Image.network(
              'http://mobilehost2019.com/AdminFoodNoWaste/images/${widget.job.jobimage}.jpg',
              fit: BoxFit.fill),
        ),
        SizedBox(
          height: 10,
  ...
  void _onAcceptJob() {
     if (widget.user.email=="user@noregister"){
      Toast.show("Please register to see food Available", context,
  ...
  Future<String> acceptRequest() async {
    String urlLoadJobs = "http://mobilehost2019.com/AdminFoodNoWaste/php/accept_job.php";
