...
import 'package:admin_foodnowaste/newjob.dart';
...
class _TabScreen2State extends State<TabScreen2> {
                              ...
                              children: <Widget>[
                                 Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    fit: BoxFit.fill,
                                    image: NetworkImage(
                                    "http://mobilehost2019.com/adminTestFinal/Images/${data[index]['jobimage']}.jpg"
                                  )))),
                                Expanded(
                                  child: Container(
                                    child: Column(
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://mobilehost2019.com/adminTestFinal/PHP/load_job_user.php";
     ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
        pr.style(message: "Loading All Accepted Foods");
    pr.show();
  ...
  Future init() async {
    if (widget.user.email=="user@noregister"){
      Toast.show("Please register to view available Food", context,
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "http://mobilehost2019.com/adminTestFinal/PHP/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
    pr.style(message: "Deleting Food Item");
    pr.show();
    http.post(urlLoadJobs, body: {
      "jobid": jobid,
    }).then((res) {
