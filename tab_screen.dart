...
import 'package:admin_foodnowaste/job.dart';
import 'package:admin_foodnowaste/jobdetail.dart';
import 'dart:convert';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:geolocator/geolocator.dart';
import 'package:flutter/services.dart';
import 'package:admin_foodnowaste/mainscreen.dart';
...
class _TabScreenState extends State<TabScreen> {
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              color: Colors.lightGreen,
                              child: Center(
                                child: Text("Free Available Today",
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white)),
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://mobilehost2019.com/adminTestFinal/PHP/load_jobs.php";
